...
public class mygroups extends javax.swing.JFrame {
    ...
    public void initgroups(){
        ...
        ab= temp.returnallgroups();
        ImageIcon image[] = new ImageIcon[ab.size()];
         record = new JButton[ab.size()];
        for(int i=0 ; i < ab.size(); i++){
           image[i] = new ImageIcon(ab.get(i).imgpath);
           record[i] =new JButton();
           record[i].setPreferredSize(new Dimension(150, 50));
           record[i].setText("Join Group");
           
           int num= ab.get(i).collectionid;
           record[i].addMouseListener(new mygroups.MouseHandler(i,num));
     ...
     private class MouseHandler extends MouseAdapter {
        ...
        public int groupstored; 
        public MouseHandler(int id,int groupid) {
            this.id=id;
            this.groupstored=groupid;
        }
